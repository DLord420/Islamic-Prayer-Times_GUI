...
if __name__ == '__main__':
    try:
        ...
        sg.theme('DarkGrey5')
        sg.Window(title="Error", layout=[[sg.Text(("Connenction error...!"), font=('Cascadia Code', 12))], [sg.Button("  Exit  ")]], element_justification='c', text_justification='c').read()
